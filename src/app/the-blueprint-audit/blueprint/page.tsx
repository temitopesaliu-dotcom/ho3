      ...
      <section className="hero hero-inner-page" id="hero" aria-label="Blueprint hero">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-note fade-up delay-3">
            $1,000 · Credited in full toward implementation · Reviewed within 48
            hours
          </p>
        </div>
      </section>
                ...
                <div className={`investment-point ${i < 2 ? "mb-4" : ""}`} key={i}>
                  <div className="investment-point-icon">
                    <svg viewBox="0 0 24 24" fill="none">
                      <circle cx="12" cy="12" r="9" stroke="#957DAD" strokeWidth="1.3" />
                      <path d="M9 12l2 2 4-4" stroke="#957DAD" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <div>
