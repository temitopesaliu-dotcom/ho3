import AiosNav from "../../components/AiosNav";
import AiosFooter from "../../components/AiosFooter";
import AiosScripts from "../../components/AiosScripts";
              ...
              >
                {[
                  ...
                  <div className="deliverable-item mb-2" key={i}>
                    <svg viewBox="0 0 16 16" fill="none">
                      <circle cx="8" cy="8" r="7" stroke="#957DAD" strokeWidth="1.2" />
                      <path d="M5 8l2 2 4-4" stroke="#957DAD" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            <div className="faq-group">
              ...
              {[
                ...
                },
                {
                  ...
                  a: "That is completely fine. You keep the Blueprint document, roadmap and all recommendations. Clients can use the Blueprint to guide their own implementation or hire others to execute it. The document is yours. No obligation exists beyond the $1,000 session.",
                },
                {
