            ...
            <div className="form-step active" role="group">
              ...
              <div className="form-fields">
                ...
                <div className="form-field">
                  ...
                  />
                  <FieldError errors={errors} field="industry" />
                </div>
                ...
                <div className="form-field">
                  ...
                  <FieldError errors={errors} field="teamSize" />
                </div>
                ...
                <div className="form-field">
                  ...
                  />
                  <FieldError errors={errors} field="businessDesc" />
                </div>
              </div>
            ...
            <div className="form-step active" role="group">
              ...
              <div className="form-fields">
                <div className="form-field">
                  ...
                  />
                  <FieldError errors={errors} field="biggestPain" />
                </div>
                ...
                <div className="form-field">
                  ...
                  />
                  <FieldError errors={errors} field="bottleneck" />
                </div>
                ...
                <div className="form-field">
                  ...
                  />
                  <FieldError errors={errors} field="currentTools" />
                </div>
              </div>
            ...
            <div className="form-step active" role="group">
              ...
              <div className="form-fields">
                <div className="form-field">
                  ...
                  <FieldError errors={errors} field="implementationBudget" />
                </div>
                ...
                <div className="form-field">
                  ...
                  <FieldError errors={errors} field="timeline" />
                </div>
              </div>
            ...
            <div className="form-step active" role="group">
              ...
              <div className="form-fields">
                <div className="form-field">
                  ...
                  <FieldError errors={errors} field="howHeard" />
                </div>
